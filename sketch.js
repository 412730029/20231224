...
function setup() {
  ...
  // btnVoiceElement.position(800,10)             
  // btnVoiceElement.size(250,80)                
  // btnVoiceElement.style("font-size","40px")   
  // btnVoiceElement.style("color","255")       
  // btnVoiceElement.style("background","45")  
